...
def M(param):
    ...
    M_diag = np.diag([mu3/4 * L3/3,  # xA
                      mu3/4 * L3/3,
                      mu3/4 * (2*L3/3 - 2*L3/5) + mu3 /
                      4 * L3/3 + mu1/2 * L1,  # xc
                      mu3/4 * (2*L3/3 - 2*L3/5) + mu3/4 * L3/3 + mu1/2 * L1,
                      mu3/4 * (2*L3/5 - L3/3) + mu3/4 *
                      (2*L3/3 - 2*L3/5) + mu2/4 * L2,  # xE
                      mu3/4 * (2*L3/5 - L3/3) + mu3/4 *
                      (2*L3/3 - 2*L3/5) + mu2/4 * L2,
                      mu3/4 * L3/3 + mu3/4 *
                      (2*L3/5 - L3/3) + mu1/4 * L1,  # xg
                      mu3/4 * L3/3 + mu3/4 * (2*L3/5 - L3/3) + mu1/4 * L1,
                      mu3/4 * L3/3,  # xh
                      mu3/4 * L3/3,
                      m3 * L3**2/12,  # phiH
                      m1 * L1**2/12,  # phiJ
    ...
    M[2, 4] += mu3/2 * (2*L3/3 - 2*L3/5)
    M[3, 5] += mu3/2 * (2*L3/3 - 2*L3/5)

    M[4, 6] += mu3/2 * (2*L3/5 - L3/3)
    M[5, 7] += mu3/2 * (2*L3/5 - L3/3)

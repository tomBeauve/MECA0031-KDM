...
"""
Different standard initial conditions for the system, 
Extracted from steady state of different systems
The last one defines the one used in the file main.py
"""
...
### Values obtained from steady state with spring ###
q_steady = np.array([
